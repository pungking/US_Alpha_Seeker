...
const RUNTIME_ENV_KEYS = [
    ...
    'HUGGINGFACE_FINBERT_MODEL',
    'HUGGINGFACE_SUMMARY_MODEL',
    'HUGGINGFACE_ENABLE_SMOKE_TEST',
    'HUGGINGFACE_SMOKE_STRICT',
    'HUGGINGFACE_TIMEOUT_MS',
    'HUGGINGFACE_RETRY',
    'HUGGINGFACE_ENABLE_ADVISORY',
    'HUGGINGFACE_ADVISORY_MAX_CANDIDATES',
    'HUGGINGFACE_ADVISORY_REQUIRE_HEADLINE',
    'HUGGINGFACE_BLEND_ENABLED',
    'HUGGINGFACE_BLEND_WEIGHT',
    'HUGGINGFACE_BLEND_MAX_DELTA',
    'HUGGINGFACE_BLEND_POSITIVE_SCALE',
    'HUGGINGFACE_BLEND_NEGATIVE_SCALE',
    'HUGGINGFACE_BLEND_MIN_ARTICLE_COUNT',
    'HUGGINGFACE_BLEND_MAX_NEWS_AGE_HOURS',
    'HUGGINGFACE_EARNINGS_WINDOW_ENABLED',
    'HUGGINGFACE_EARNINGS_WINDOW_BLOCK_DAYS',
    ...
    'PERPLEXITY_STAGE2_MAX_TOKENS',
    'PERPLEXITY_TOP6_MAX_TOKENS',
    'PERPLEXITY_AUDIT_MAX_TOKENS',
    'PERPLEXITY_MACRO_MAX_TOKENS',
    'PERPLEXITY_TOKEN_WARN_THRESHOLD',
    'RAPID_API_KEY',
    'POLYGON_API_KEY',
    'ALPACA_KEY',
    'ALPACA_SECRET',
