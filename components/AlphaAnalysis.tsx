...
const AlphaAnalysis: React.FC<Props> = ({ selectedBrain, setSelectedBrain, onFinalSymbolsDetected }) => {
  ...
  const executeAlphaFinalization = async () => {
    ...
    addLog(`Initiating Phase 6 Synthesis with ${brainName}...`, "info");
             ...
             <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2 space-y-8">
                   ...
                   {currentBacktest && (
                     <div className="grid grid-cols-1 gap-6 animate-in zoom-in-95 duration-500">
                        ...
                        <div className="h-64 w-full bg-black/40 rounded-3xl border border-white/5 p-6">
                           <p className="text-[10px] font-black text-slate-500 uppercase mb-4 tracking-widest italic opacity-50">Historical Equity Projection (24M)</p>
                   ...
                   <div className="p-10 bg-white/5 rounded-[32px] border border-white/5">
                      <h4 className="text-[10px] font-black text-rose-500 uppercase tracking-widest mb-6 italic">Strategic Technical Outlook</h4>
                ...
                <div className="space-y-8 pt-4">
                   <div className="p-10 bg-rose-500/10 rounded-[40px] border border-rose-500/20 shadow-xl relative overflow-hidden">
                      ...
                      <div className="flex items-center space-x-6 mb-6">
                         ...
                         <span className="text-xl font-black text-white">{selectedStock.convictionScore?.toFixed(0)}%</span>
                      </div>
                   ...
                   <div className="p-8 bg-white/5 rounded-[32px] border border-white/5">
                      <p className="text-[9px] font-black text-slate-600 uppercase mb-4 tracking-widest italic">Core Reasoning</p>
